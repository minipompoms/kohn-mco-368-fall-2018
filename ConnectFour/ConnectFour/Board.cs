...
namespace ConnectFour
{
    class Board
    {
        ...
        private bool isWinConfiguration(Cell color, int row, int col)
        {
            ...
            { // then check up, right UR diag, right, LR diag
                retVal = checkUpward(color, row, col)
        ...
        private bool checkUpDiag(Cell color, int row, int col)
        {
            ...
            {
                retVal = color == board[row + 1, col + 1]
